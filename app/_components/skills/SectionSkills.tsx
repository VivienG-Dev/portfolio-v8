  ...
  return (
    <Section className="flex flex-col items-start gap-4" title="Compétences" rotate="rotate-90" position="-left-20">
      ...
      <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <motion.div variants={createVariants(0)} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <Skills
            title="Front-end"
        ...
        <motion.div variants={createVariants(0.2)} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <Skills
            title="Back-end"
        ...
        <motion.div variants={createVariants(0.4)} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <Skills
            title="Design"
