export const Title = ({ title, as: Heading = "h2" }: { title: string; as?: "h1" | "h2" }) => (
  <div className="relative isolate pt-3 pl-4">
    <span aria-hidden="true" className="pointer-events-none absolute left-4 top-0 -z-10 select-none text-2xl font-bold leading-tight tracking-tight text-black/[0.07] dark:text-white/[0.07] sm:left-2 sm:text-5xl">
      {title}
    </span>
